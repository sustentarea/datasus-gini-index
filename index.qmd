...
[![](https://img.shields.io/badge/OSF-10.17605/OSF.IO/WHJ92-1284C5.svg)](https://doi.org/10.17605/OSF.IO/WHJ92)
:::
...
The pipeline is fully reproducible and can be run again at any time. See the [README](https://github.com/danielvartan/datasus-gini-index/blob/main/README.md) file in the code repository to learn how to run it.
